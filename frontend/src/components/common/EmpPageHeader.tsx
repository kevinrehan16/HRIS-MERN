...
const EmpPageHeader: React.FC<EmpPageHeaderProps> = ({ title, subtitle, titleIcon, children }) => {
  return (
    /* Inalis ang mb-8 at rounded-b-xl para maging flat sa ilalim at walang space */
    <div className="bg-gradient-to-r from-purple-500 to-purple-700 pt-2 pb-28 px-4 text-white shadow-lg">
