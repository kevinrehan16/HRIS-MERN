...
export const getNightDiffMinutes = (timeIn, timeOut) => {
    let nightDiffMins = 0;
...
export const createPayrollPeriod = catchAsync(async (req, res) => {
...
export const voidPayroll = catchAsync(async (req, res) => {
    const { periodStart, periodEnd } = req.body;
...
export const getMyPayrolls = catchAsync(async (req, res) => {
...
export const getPayrollSummary = catchAsync(async (req, res) => {
...
export const getAllPayrolls = catchAsync(async (req, res) => {
    ...
    const formattedPayrolls = payrolls.map((pay) => ({
        ...
        deductions: {
            ...
            totalDeductions: pay.absentDeduction +
                pay.lateDeduction +
