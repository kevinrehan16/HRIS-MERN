export const calculateSSS = (grossMonthly) => {
    if (grossMonthly < 5000)
        return 225;
    if (grossMonthly >= 29750)
        return 1350;
    return grossMonthly * 0.045;
};
export const calculatePhilHealth = (grossMonthly) => {
...
export const calculatePagIBIG = (grossMonthly) => {
