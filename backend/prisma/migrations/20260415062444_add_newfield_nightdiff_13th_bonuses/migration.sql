...
-- AlterTable
ALTER TABLE `payroll` ADD COLUMN `accrued13thMonth` DOUBLE NOT NULL DEFAULT 0,
    ADD COLUMN `accruedOtherBonuses` DOUBLE NOT NULL DEFAULT 0,
    ADD COLUMN `nightDiffPay` DOUBLE NOT NULL DEFAULT 0;
