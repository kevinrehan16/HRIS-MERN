...
-- AlterTable
ALTER TABLE `position` ADD COLUMN `departmentId` INTEGER NULL,
    ADD COLUMN `maxSalary` DECIMAL(10, 2) NOT NULL DEFAULT 0.0,
    ADD COLUMN `minSalary` DECIMAL(10, 2) NOT NULL DEFAULT 0.0;
